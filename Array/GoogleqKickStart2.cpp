...
int main(){
    ...
    cout<<"Enter n: ";
    cin>>n;
    int arr[n+1];         // becuz we have to compare i+1
    arr[n] = -1;          // LAst element set to -1;   it will always satisfies the positive of a[i] > arr[i+1];   , No. of vistors are non negative
